...
public class NoteService {
     ...
     * @throws InvalidIdException    when the id is either below 0 or above the max integer value.
     */
     ...
     *
     * @param id the id of the note you want to get from storage.
     * @throws InvalidIdException when id is either below 0, or above integer max value.
     */
